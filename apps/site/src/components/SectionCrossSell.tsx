...
const picks = [
  { role: 'COMPLEMENT', name: 'Filtre HEPA de rechange', price: '29€', reason: 'pour garder l\'aspi performant 12 mois.', tint: 'from-toxic-300 to-toxic-600', dot: 'bg-toxic-500' },
  { role: 'ACCESSOIRE', name: 'Brosse spéciale tapis', price: '19€', reason: 'utile dès que vous ajoutez un tapis.', tint: 'from-toxic-200 via-toxic-400 to-toxic-500', dot: 'bg-toxic-400' },
  { role: 'PREMIUM', name: 'Silenz Pro Max · 16 kPa', price: '349€', reason: 'l\'option +100€ qui gère gros animaux.', tint: 'from-toxic-500 via-toxic-700 to-ink', dot: 'bg-toxic-700' },
  { role: 'ALTERNATIVE', name: 'Compact Mini · sans fil', price: '199€', reason: 'si vous préférez sans fil pour étages.', tint: 'from-toxic-100 via-toxic-200 to-toxic-400', dot: 'bg-toxic-300' },
];
        ...
        <div className="mt-16 grid grid-cols-12 gap-x-6 gap-y-16">
          <div className="col-span-12 lg:col-span-4">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4">
              <RoleBadge label="Complément" tint="bg-toxic-500/12 text-toxic-700" />
              <RoleBadge label="Accessoire" tint="bg-toxic-400/12 text-toxic-700" />
              <RoleBadge label="Premium" tint="bg-toxic-700/12 text-toxic-800" />
              <RoleBadge label="Alternative" tint="bg-toxic-300/15 text-toxic-700" />
            </div>
          </div>
