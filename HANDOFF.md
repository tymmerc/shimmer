...
- **UX vendeur : ouverture à la validation (16 sept, décision Tym)** : le SDK n'intercepte PLUS le focus de la barre de recherche. Le visiteur tape dans la barre native du thème (suggestions natives comprises), Shimmer s'ouvre à Entrée/submit (≥2 caractères) et remplace la page de résultats. Même déclencheur que l'enrôlement témoin → groupes comparables. Reste à faire du pack "intégration impeccable" : Shadow DOM, auto-habillage aux couleurs de la boutique, résultats instantanés pendant la frappe, banc d'essai thèmes Shopify réels.
