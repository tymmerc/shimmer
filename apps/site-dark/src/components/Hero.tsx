...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-[1480px] grid-cols-12 gap-x-6 px-6 pt-32 pb-20 md:px-12">
        <motion.div
        ...
        >
          <div className="mb-10 inline-flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.24em] text-ink-mute">
            <span className="h-1.5 w-1.5 rounded-full bg-toxic-500 shadow-[0_0_12px_rgba(106,43,245,0.85)]" />
            Vendeur IA · v0.4 · Cross-sell narratif
          </div>

          <h1 className="font-display text-balance text-[clamp(64px,11vw,180px)] font-normal leading-[0.88] tracking-tightest">
            Un vendeur qui{' '}
    ...
    <header className="absolute left-0 right-0 top-0 z-40 px-6 py-6 md:px-12">
      <div className="mx-auto flex max-w-[1480px] items-center justify-between">
        ...
        <nav className="hidden gap-8 md:flex">
          ...
          <a href="#stack" className="font-mono text-[11px] uppercase tracking-[0.2em] text-ink-mute transition hover:text-ink">Stack</a>
        </nav>
        <a
          href="/shimmer/docs.html"
          className="hidden rounded-full border border-ink/25 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.18em] transition hover:border-ink md:inline-flex"
        >
          API
        </a>
      </div>
